  ...
  return(
    <>
      <div className="m-6 p-3 bg-aliceblue rounded-lg shadow-md">
        <h2 className="text-2xl font-semibold text-gray-800 text-center">Programming Experience</h2>
      </div>
      <div className="m-6 p-3 bg-aliceblue rounded-lg shadow-md">
        <table>
          <thead className="bg-lightblue">
            <tr>
              ...
              <th className="font-bold">Years Experience</th>
            </tr>
          </thead>
          <tbody>
            <tr>
    ...
    <div className="m-6 p-3 bg-aliceblue rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold text-gray-800 text-center">College Experience</h2>
    </div>
